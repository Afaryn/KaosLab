...
interface AuthRepository {
    ...
    fun sendEmailVerification(): Flow<Response<String>>
    fun resendEmailVerification(email: String, password: String): Flow<Response<String>>
    fun resetPassword(email: String): Flow<Response<String>>
    fun logout()
    fun userUid(): String
