package com.afaryn.kaoslab.presentation.ui_designer.home
...
import com.afaryn.kaoslab.databinding.FragmentHomeDesignerBinding
import com.afaryn.kaoslab.domain.model.Product
import com.afaryn.kaoslab.presentation.ui_designer.home.adapter.ProductAdapter
import com.afaryn.kaoslab.presentation.ui_designer.home.viewModel.HomeDesignerViewModel
...
class HomeDesignerFragment : Fragment() {

    private var _binding : FragmentHomeDesignerBinding?=null
    private val binding get() = _binding!!
    private val viewModel by viewModels<HomeDesignerViewModel>()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHomeDesignerBinding.inflate(layoutInflater)
        return binding.root
    }
